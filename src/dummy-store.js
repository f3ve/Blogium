export default {
  users: [
    ...
    {
      id: 2,
      full_name: "Jamie Dude",
      username: "Jamo",
      email: "jamie@email.com",
      password: "password",
      bio:
        "Hi my name is Jamie and I wished I looked as good as the dude from Outlander",
      date_created: new Date(),
      date_modified: new Date(),
      img: "https://picsum.photos/200",
    },
    {
      id: 3,
      full_name: "Josh McJosh",
      username: "JoshyWashy",
      email: "josh@email.com",
      password: "password",
      bio: `My parents thought it would be funny to name me Josh because my last name is McJosh. It wasn't.`,
      date_created: new Date(),
      date_modified: new Date(),
      img: "https://picsum.photos/200",
    },
  ...
  posts: [
    ...
    },
    {
      ...
      user: {
        ...
        img: "https://picsum.photos/200",
        bio:
          "Hi my name is Jamie and I wished I looked as good as the dude form Outlander",
      },
    },
    {
      id: 4,
  ...
  comments: [
    ...
    },
    {
      ...
      id: 6,
      content:
        "We should really start exploring some new languages, like pig latin.",
      date_created: new Date(),
      user: {
        id: 1,
        username: "Jimbo",
