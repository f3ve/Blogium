...
export default class Account extends React.Component {
  ...
  onSuccessfulUpdate = (user) => {
    ...
    this.context.setActiveUser(user, () => this.context.setError('Update Successful'))
  }
      ...
      <React.Fragment>
        <form className='account-form' onSubmit={e => this.handleSubmit(e)}>
          ...
          <button 
            ...
            disabled={
              this.validateName() || 
              this.state.full_name.changed === false
            }
          >
            update name
          </button>
          ...
          <input type='email' id='email' defaultValue={user.email} onChange={e => this.updateEmail(e)} />
          {
          ...
          <button 
            ...
            disabled={
              this.validateEmail() ||
              this.state.email.changed === false
            }
          >
            update email
          </button>
          ...
          <textarea id={'bio'} defaultValue={user.bio} onChange={e => this.updateBio(e)} rows='5' cols='33'></textarea>
          <button 
            className='clickMe'
